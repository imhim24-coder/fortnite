...
window.dialogue_polarBear=function(player,items,NPCs){
    ...
    return function(diff){
        ...
        return ["Let me cook lil bro","So good it'll permanently increase the maximum energy of your bees by 5%! I'll even throw in some honey for dessert!","Now, if you'll excuse me, I'm going back to coding. I don't do this in the real game, but I heard polar bears are nerds at coding.",
        ...
        ,"Alr buddy","A dash of honey... ...(stir)...","All done! Enjoy!","Well, I'm always ready to eat. I'll be waiting when you're ready for more cooking!",function(){addReward(rew)}
...
window.dialogue_giftedBuckoBee=function(player,items,NPCs){
    ...
    return function(diff){
        ...
        if(diff){
            ...
            if(!(diff%3)) rew.push(['royalJelly',2000])
            
            if(!(diff%2)) rew.push(['blueberry',500000])
        ...
        return ['!!!',"Welcome to/back to the Blue HQ!","Be sure you complete my quests often for bluey rewards!","Buzz buzz...","Here's your quest!",
            ...
            function(){
                ...
                switch((rand()*9)|0){
                    ...
                    case 8:
                        player.addQuest('Fondle Them Blues',[['pollenFromPineTreeForest',diff*diff*200000+200000],['bluePollen',(diff+1)*(diff+1)*8000000+420]],'giftedBuckoBee')
                }
            }
            ...
            function(){
                ...
                switch((rand()*9)|0){
                    ...
                    case 8:
                        ...
                        player.addQuest('Fondle them reds',[['pollenFromRoseField',diff*diff*200000+200000],['pollenFromSpiderField',diff*diff*400000+420000],['pollenFromStrawberryField'],diff*diff*200000+200000]], 'giftedRileyBee')
                }
            }
